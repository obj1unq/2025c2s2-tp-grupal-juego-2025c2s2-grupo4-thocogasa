...
class Caballos {
    ...
    method verificarCaptura() {
        const posicionesDiagonales = [self.position().up(2).left(1), 
    ...
    method hayPiezaEnemigaEnRango(posicion) {
        ...
        // 2. ¿Está el enemigo en una casilla de captura diagonal válida?
        const enRangoDiagonal = posicion == self.position().up(2).left(1) or 
                                posicion == self.position().up(2).right(1) or
                                posicion == self.position().up(1).right(2) or
                                posicion == self.position().up(1).right(2) or
                                posicion == self.position().down(2).left(1) or 
                                posicion == self.position().down(2).right(1) or
                                posicion == self.position().down(1).right(2) or
                                posicion == self.position().down(1).left(2)
